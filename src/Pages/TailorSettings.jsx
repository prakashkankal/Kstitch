                                ...
                                <div key={day} className="flex items-center justify-between">
                                    ...
                                    <div className="flex gap-4 items-center">
                                        <input
                                            ...
                                            className="px-4 py-2 rounded-lg bg-white/60 border border-white/40 focus:outline-none focus:ring-2 focus:ring-violet-500/50 disabled:opacity-50 disabled:cursor-not-allowed"
                                        />
